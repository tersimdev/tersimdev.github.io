...
(function() {
   ...
   */
  let documentMaxScollHeightTop = document.body.scrollHeight - window.screen.height;
  let navbarlinks = select('#navbar .scrollto', true)
  const navbarlinksActive = () => {
    let position = window.scrollY + 200
    if (documentMaxScollHeightTop - window.scrollY < 100)
    {      
      ...
      navbarlinks.at(-1).classList.add('active')
    }
    else
    {
      navbarlinks.forEach(navbarlink => {
